...
public final class EntandoOperatorTestConfig extends EntandoOperatorConfigBase {
    ...
    private static final String ENTANDO_TEST_KEYCLOAK_USER = "entando.test.keycloak.user";
    private static final String ENTANDO_TEST_KEYCLOAK_PASSWORD = "entando.test.keycloak.password";
    ...
    public static String getKeycloakUser() {
        return lookupProperty(ENTANDO_TEST_KEYCLOAK_USER).orElseThrow(() -> new IllegalStateException("No test Keycloak user configured"));
    }
