...
class EntandoDatabaseServiceMockedTest extends AbstractEntandoDatabaseServiceTest {
    ...
    void testOverriddenEqualsMethods() {
        ...
        EntandoDatabaseServiceBuilder builder = new EntandoDatabaseServiceBuilder().editMetadata().withNamespace("ns").withName("name")
                .endMetadata();
